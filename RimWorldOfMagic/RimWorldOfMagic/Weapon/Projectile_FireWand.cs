...
namespace TorannMagic.Weapon
{
    public class Projectile_FireWand : Projectile_AbilityBase
    {
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            try
            {
                //ExplosionHelper.Explode(base.Position, map, 1, DamageDefOf.Burn, this.launcher, Mathf.RoundToInt(this.def.projectile.GetDamageAmount(1,null) * this.arcaneDmg), 2, SoundDefOf.Crunch, def, this.equipmentDef, null, null, 0f, 1, false, null, 0f, 1, 0, true);
            }
            catch
            {
                //don't care
