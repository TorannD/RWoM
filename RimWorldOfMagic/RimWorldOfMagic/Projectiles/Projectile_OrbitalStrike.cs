    ...
    public class Projectile_OrbitalStrike : Projectile_AbilityBase
    {
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            if (this.age == (this.targettingAge + this.beamDuration))
            {
                ...
                ExplosionHelper.Explode(this.strikePos, map, this.def.projectile.explosionRadius, DamageDefOf.Bomb, this.launcher as Pawn, Mathf.RoundToInt((25 + 5*pwrVal) * this.arcaneDmg), 0, null, def, this.equipmentDef, null, null, 0f, 1, null, false, null, 0f, 1, 0f, false);
