    ...
    public class Projectile_ShadowStrike : Projectile_AbilityBase
    {
        ...
        public void DoStrike(Thing target)
        {
            ...
            if(verVal >= 3)
            {
                ...
                ExplosionHelper.Explode(caster.Position, caster.Map, radius, TMDamageDefOf.DamageDefOf.TM_Toxin, caster, 0, 0, TMDamageDefOf.DamageDefOf.TM_Toxin.soundExplosion, null, null, null, fog, 1f, 1, null, false, null, 0f, 0, 0.0f, false);
