	...
	public class Projectile_Firestorm : Projectile_AbilityBase
	{
        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            for (int i = 0; i <= heavyCount; i++)
            {
                ...
                {
                    ExplosionHelper.Explode(shrapnelPos[heavyCount], map, .4f, TMDamageDefOf.DamageDefOf.TM_Firestorm_Small, this.launcher, Rand.Range(5, this.def.projectile.GetDamageAmount(1,null)), 0, SoundDefOf.BulletImpact_Ground, def, this.equipmentDef, null, null, 0f, 1, null, false, null, 0f, 1, 0.2f, false);
                    ticksTillHeavy[i]--;
                }
                else
                {
