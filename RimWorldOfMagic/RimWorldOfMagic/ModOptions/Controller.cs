    ...
    public class Controller : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect canvas)
        {
            ...
            if (reset)
            {
                ...
                Settings.Instance.baseMageChance = 0.2f;
                Settings.Instance.baseFighterChance = 0.2f;
                Settings.Instance.advMageChance = 0.1f;
                Settings.Instance.advFighterChance = 0.1f;
            ...
            if (challenge)
            {
                ...
                Settings.Instance.AIFighterMarking = false;
                Settings.Instance.AIFriendlyMarking = false;
                Settings.Instance.baseMageChance = .16f;
                Settings.Instance.baseFighterChance = .16f;
                Settings.Instance.advMageChance = 0.3f;
                Settings.Instance.advFighterChance = 0.3f;
            ...
            if (easy)
            {
                ...
                Settings.Instance.AIFighterMarking = false;
                Settings.Instance.AIFriendlyMarking = false;
                Settings.Instance.baseMageChance = 0.4f;
                Settings.Instance.baseFighterChance = 0.4f;
                Settings.Instance.advMageChance = 0.2f;
                Settings.Instance.advFighterChance = 0.2f;
