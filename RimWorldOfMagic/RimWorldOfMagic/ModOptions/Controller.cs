...
namespace TorannMagic.ModOptions
{
    public class Controller : Mod
    {
        ...
        {            
            ...
            classOptions = Widgets.ButtonText(rowRectShiftRight, "TM_ClassOptions".Translate(), true, false, true);
            if (classOptions)
            {
            ...
            factionOptions = Widgets.ButtonText(rowRectShiftRightPlus, "TM_FactionOptions".Translate(), true, false, true);
            if (factionOptions)
            {
                Rect rect = new Rect(64f, 64f, 480, 640);
            ...
            eventOptions = Widgets.ButtonText(rowRect2ShiftRight, "TM_EventOptions".Translate(), true, false, true);
            if (eventOptions)
            {
            ...
            factionOptions = Widgets.ButtonText(rowRect2ShiftRightPlus, "TM_GolemOptions".Translate(), true, false, true);
            if (factionOptions)
            {
                Rect rect = new Rect(64f, 64f, 480, 640);
            ...
            Rect rowRect21ShiftRight = UIHelper.GetRowRect(rowRect21, rowHeight, num);
            rowRect21ShiftRight.x += rowRect.width + 56f;
            rowRect21ShiftRight.width /= 3;
            displayOptions = Widgets.ButtonText(rowRect21ShiftRight, "TM_DisplayOptions".Translate(), true, false, true);
            if (displayOptions)
            {
                Rect rect = new Rect(64f, 64f, 480, 640);
                DisplayOptionsWindow newWindow = new DisplayOptionsWindow();
                Find.WindowStack.Add(newWindow);
            }
            num++;            
            ...
            //num++;
            num++;
            Rect rowRect20 = UIHelper.GetRowRect(rowRect13, rowHeight, num);
