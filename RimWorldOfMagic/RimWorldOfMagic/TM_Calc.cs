...
namespace TorannMagic
{
    public static class TM_Calc
    {
        ...
        public static bool IsNecromancer(Pawn pawn)
        {
            ...
            if (pawn.GetCompAbilityUserMagic() is { customClass: { isNecromancer: true } }) return true;
            if (pawn.GetCompAbilityUserMight() is { customClass: { isNecromancer: true } }) return true;
