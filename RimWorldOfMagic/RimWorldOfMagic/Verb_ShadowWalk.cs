                    ...
                    if (verVal > 0)
                    {
                        ...
                        if (targetPawn.Faction != null && targetPawn.Faction == p.Faction)
                        {
                            ...
                            if (verVal > 2)
                            {
                                ...
                                GenExplosion.DoExplosion(p.Position, p.Map, 2, TMDamageDefOf.DamageDefOf.TM_Toxin, caster, 0, 0, TMDamageDefOf.DamageDefOf.TM_Toxin.soundExplosion, null, null, null, fog, 1f, 1, null, null, 0, false, null, 0f, 0, 0.0f, false);
