        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            else if(phase3Flag)
            {
                ...
                if(expandingTick < 4)
                {
                    ...
                    ExplosionHelper.Explode(this.strikePos, this.Map, this.radius/(4-this.expandingTick), DamageDefOf.Bomb, this.launcher, Mathf.RoundToInt(Rand.Range(this.damage *.7f, this.damage*.9f)), 1, DamageDefOf.Bomb.soundExplosion, null, null, null, null, 0, 0, null, false, null, 0, 0, .4f, true);
                }
            }
