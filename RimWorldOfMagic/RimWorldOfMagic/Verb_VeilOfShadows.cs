    ...
    public class Verb_VeilOfShadows : Verb_UseAbility
    {
        ...
        protected override bool TryCastShot()
        {
            ...
            if (flag)
            {
                ...
                GenExplosion.DoExplosion(caster.Position, caster.Map, 3f + (.3f * verVal), TMDamageDefOf.DamageDefOf.TM_Toxin, caster, 0, 0, TMDamageDefOf.DamageDefOf.TM_Toxin.soundExplosion, null, null, null, fog, 1f, 1, null, null, 0, false, null, 0f, 0, 0.0f, false);
