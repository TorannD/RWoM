        ...
        protected override void Impact(Thing hitThing, bool blockedByShield = false)
        {
            ...
            if (age < duration)
            {
                ...
                if (caster != null && !initialized)
                {
                    ...
                    GenExplosion.DoExplosion(base.Position, map, radius, TMDamageDefOf.DamageDefOf.TM_Poison, this, 0, 0, SoundDef.Named("TinyBell"), def, null, null, fog, 1f, 1, null, null, 0, false, null, 0f, 0, 0.0f, false);
                }
