...
namespace TorannMagic
{
    ...
    public class FlyingObject_Advanced_Icebolt : FlyingObject_Advanced
    {
        public override void ImpactOverride()
        {
            ...
            GenExplosion.DoExplosion(base.Position, map, 0.4f, TMDamageDefOf.DamageDefOf.Iceshard, this.launcher, Mathf.RoundToInt(this.def.projectile.GetDamageAmount(1, null)), 0, this.def.projectile.soundExplode, def, this.equipmentDef, null, null, 0f, 1, null, null, 0, false, null, 0f, 1, 0f, false);
