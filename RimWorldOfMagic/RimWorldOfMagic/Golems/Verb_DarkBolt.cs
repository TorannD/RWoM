...
namespace TorannMagic.Golems
{
    public class Verb_DarkBolt : Verb_GolemShoot
    {
        protected override bool TryCastShot()
        {
            ...
            flyingObject.AdvancedLaunch(CasterPawn, TorannMagicDefOf.Mote_Shadow, 3, 0, false, CasterPawn.DrawPos, tmpTarget, launchedThing, Mathf.RoundToInt((Rand.Range(.8f, 1.2f) * this.verbProps.defaultProjectile.projectile.speed)), 
                this.verbProps.defaultProjectile.projectile.explosionRadius > 0, Rand.Range(45,55),
