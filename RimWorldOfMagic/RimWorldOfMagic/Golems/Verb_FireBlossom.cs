    ...
    public class Verb_FireBlossom : Verb_GolemShoot
    {
        ...
        protected override bool TryCastShot()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                {
                    tmpTarget = TM_Calc.FindValidCellWithinRange(currentTarget.Cell, CasterPawn.Map, 6);
                }
                ...
                flyingObject.AdvancedLaunch(CasterPawn, null, 0, Mathf.Clamp(Rand.Range(5, 80),
                    0, tmpTarget.Cell.DistanceToEdge(CasterPawn.Map)), false, CasterPawn.DrawPos, tmpTarget, launchedThing, Mathf.RoundToInt((Rand.Range(.8f, 1.2f) * this.verbProps.defaultProjectile.projectile.speed)), this.verbProps.defaultProjectile.projectile.explosionRadius > 0, Rand.Range(16, 24),
