        ...
        public static void Targeter_Casting_Postfix(Targeter __instance)
        {
            if (__instance.targetingSource != null && __instance.targetingSource.CasterIsPawn)
            {
                ...
                if (caster != null)
                {
                    ...
                    if (targ != IntVec3.Invalid && __instance.targetingSource.GetVerb != null && __instance.targetingSource.GetVerb.EquipmentSource == null && __instance.targetingSource.GetVerb.loadID == null) // && __instance.targetingSource.GetVerb.EquipmentSource == null)
                    {
