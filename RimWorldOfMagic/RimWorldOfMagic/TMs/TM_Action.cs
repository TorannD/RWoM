    ...
    public static class TM_Action
    {
        ...
        public static bool DoWildSurge(Pawn p, CompAbilityUserMagic comp, MagicAbility ability, TMAbilityDef abilityDef, LocalTargetInfo target, bool canDoBad = true)
        {
            ...
            else if ((rnd < bad) && canDoBad)
            {
                ...
                {
                    case 0:
                        ExplosionHelper.Explode(p.Position, p.Map, 5f, DamageDefOf.Bomb, p, Rand.Range(8, 12), 1f, null, null, null, null, null, 0, 1, null, false, null, 0, 1, 0, true);
                        surgeText = "Explosion";
                        break;
                    case 1:
        ...
        public static void CreateMagicDeathEffect(Pawn pawn, IntVec3 pos, bool canCauseDeath = true, bool friendlyFire = false)
        {
            ...
            switch (rnd)
            {
                case 0: //Death explosion
                    ...
                    p = pawn;
                    Map map = p.Map;
                    ExplosionHelper.Explode(p.Position, p.Map, 0f, DamageDefOf.Burn, p as Thing, 0, 0, SoundDefOf.Thunder_OnMap, null, null, null, null, 0f, 0, null, false, null, 0f, 0, 0.0f, false);
                ...
                case 3: //summon 4x blizzard skyfallers
                    ...
                    break;
                case 4: //stun pulse
                    ExplosionHelper.Explode(pos, pawn.Map, 6, DamageDefOf.Stun, pawn, 0, 0);
        ...
        public static void CreateMightDeathEffect(Pawn pawn, IntVec3 pos)
        {
            ...
            switch (rnd)
            {
                ...
                case 2: //burst into flames
                    ExplosionHelper.Explode(pawn.Position, pawn.Map, 2f, DamageDefOf.Flame, pawn, 10, 0, DamageDefOf.Flame.soundExplosion);
                    break;
                case 3: //wave of fear
