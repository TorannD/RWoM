...
namespace TorannMagic
{
	public class Projectile_SmokeCloud : Projectile_AbilityBase
	{
		...
		{            
            ...
            GenExplosion.DoExplosion(base.Position, map, explosionRadius, this.def.projectile.damageDef, this.launcher, this.def.projectile.GetDamageAmount(1,null), 0, SoundDefOf.Artillery_ShellLoaded, def, this.equipmentDef, null, null, 1f, 1, GasType.BlindSmoke, null, 0, false, null, 0f, 1, 0f, false);
