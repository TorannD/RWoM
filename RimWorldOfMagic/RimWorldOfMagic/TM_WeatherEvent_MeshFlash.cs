    ...
    public class TM_WeatherEvent_MeshFlash : WeatherEvent
    {
        ...
        public override void FireEvent()
        {
            ...
            if (!this.strikeLoc.Fogged(this.map))
            {
                ...
                GenExplosion.DoExplosion(this.strikeLoc, this.map, (Rand.Range(.8f, 1.2f) * this.averageRadius), this.damageType, instigator, this.damageAmount, -1f, exp, null, null, null, null, 0f, 1, null, null, 0, false, null, 0f, 1, 0f, false);
